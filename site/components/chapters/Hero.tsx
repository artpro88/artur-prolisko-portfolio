 ...
 *  Entrance is pure CSS (.reveal-now) so the headline paints at first paint
 *  — the LCP element must never wait for hydration. */
  ...
  return (
    <section id="hero" className="chapter ground-dark-alt">
      <div className="wrap grid items-center gap-8 md:grid-cols-[1.05fr_.95fr]">
        <div>
          <p className="eyebrow reveal-now">
            Head of Product · Sportsbook · Casino · Live Casino
          </p>
          <h1 className="h-hero focus-now mt-5">
            Senior Product
            <br />
            Design Leader for
            <br />
          ...
          <p
            className="lead reveal-now mt-6 max-w-[36ch]"
          ...
          <div
            className="reveal-now mt-10 inline-flex items-center gap-2.5 text-[0.7rem] uppercase opacity-60"
            style={{
